...
<html lang="vi">
   <head>
      ...
      <style>#header .site-title {background: url(https://dynamic.brandcrowd.com/asset/logo/27e99356-234a-4c80-b636-514d491fa249/logo-search-grid-2x?logoTemplateVersion=1&v=637924971402000000&text=movie+web) no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   </head>
         ...
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  ...
                  Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[vanminh291974@gmail.com&#160;]</a>
               </div>
            </div>
         </div>
      </footer>
